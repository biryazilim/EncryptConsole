    ...
    LPTSTR pszPassword)
{
    ...
    {
        MyHandleError(
            (LPTSTR)TEXT("Error opening source plaintext file!\n"),
            GetLastError());
    ...
    {
        MyHandleError(
            (LPTSTR)TEXT("Error opening destination file!\n"),
            GetLastError());
        goto Exit_MyEncryptFile;
    }
    ...
    if (!pszPassword || !pszPassword[0])
    {
        ...
        {
            MyHandleError(
                (LPTSTR)TEXT("Error during CryptGenKey. \n"),
                GetLastError());
            goto Exit_MyEncryptFile;
        }
        ...
        else
        {
            ...
            {
                MyHandleError(
                    (LPTSTR)TEXT("User public key is not available and may ")
                    TEXT("not exist.\n"),
                    GetLastError());
                goto Exit_MyEncryptFile;
            }
        ...
        {
            MyHandleError(
                (LPTSTR)TEXT("Error computing BLOB length! \n"),
                GetLastError());
            goto Exit_MyEncryptFile;
        }
        ...
        {
            MyHandleError(
                (LPTSTR)TEXT("Error during CryptExportKey!\n"),
                GetLastError());
            goto Exit_MyEncryptFile;
        }
        ...
        {
            MyHandleError(
                (LPTSTR)TEXT("Error writing header.\n"),
                GetLastError());
            goto Exit_MyEncryptFile;
        }
        else
    ...
    else
    {
        ...
        {
            MyHandleError(
                (LPTSTR)TEXT("Error during CryptCreateHash!\n"),
                GetLastError());
            goto Exit_MyEncryptFile;
        }
        ...
        {
            MyHandleError(
                (LPTSTR)TEXT("Error during CryptHashData. \n"),
                GetLastError());
            goto Exit_MyEncryptFile;
        }
        ...
        {
            MyHandleError(
                (LPTSTR)TEXT("Error during CryptDeriveKey!\n"),
                GetLastError());
            goto Exit_MyEncryptFile;
        }
    }
    ...
    do
    {
        ...
        {
            MyHandleError(
                (LPTSTR)TEXT("Error reading plaintext!\n"),
                GetLastError());
            goto Exit_MyEncryptFile;
        }
        ...
        {
            MyHandleError(
                (LPTSTR)TEXT("Error during CryptEncrypt. \n"),
                GetLastError());
            goto Exit_MyEncryptFile;
        }
        ...
        {
            MyHandleError(
                (LPTSTR)TEXT("Error writing ciphertext.\n"),
                GetLastError());
            goto Exit_MyEncryptFile;
        }
